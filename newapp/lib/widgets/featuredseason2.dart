...
class FeaturedSeason2 extends StatefulWidget {
  @override
  _FeaturedSeason2State createState() => _FeaturedSeason2State();
}

class _FeaturedSeason2State extends State<FeaturedSeason2> {
  @override

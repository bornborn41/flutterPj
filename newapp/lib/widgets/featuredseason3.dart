...
class FeaturedSeason3 extends StatefulWidget {
  @override
  _FeaturedSeason3State createState() => _FeaturedSeason3State();
}

class _FeaturedSeason3State extends State<FeaturedSeason3> {
  @override

...
class ProductDetails extends StatelessWidget {
  ...
  ProductDetails({@required this.name,@required this.season,@required this.description,@required this.picture});
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            padding: const EdgeInsets.all(10.0),
                            child: Text('$season', textAlign: TextAlign.end,style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w100),),
                          ),
                        ],
                      ),
                    )),
...
//   final String picture;
//   FeaturedCard({@required this.name,@required this.season,@required this.description,@required this.picture});
//   @override

...
class FeaturedSeason1 extends StatefulWidget {
  @override
  _FeaturedSeason1State createState() => _FeaturedSeason1State();
}

class _FeaturedSeason1State extends State<FeaturedSeason1> {
  @override
    ...
    return Container(
        ...
        child: ListView.builder(
            ...
            itemBuilder: (_, index) {
              ...
              //   name: 'Grimms The Series',
              //   season: 'Season 1',
              //  description: 1,
              //   picture: 'assets/images/born.jpg',
              // );

...
class FeaturedSeason4 extends StatefulWidget {
  @override
  _FeaturedSeason4State createState() => _FeaturedSeason4State();
}

class _FeaturedSeason4State extends State<FeaturedSeason4> {
  @override

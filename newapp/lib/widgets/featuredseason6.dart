...
class FeaturedSeason6 extends StatefulWidget {
  @override
  _FeaturedSeason6State createState() => _FeaturedSeason6State();
}

class _FeaturedSeason6State extends State<FeaturedSeason6> {
  @override
